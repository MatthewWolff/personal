...
$INSTALL_LOC/zsh/configure --prefix=$INSTALL_LOC > /dev/null && echo "  -Success"
...
[[ -d $HOME/.oh-my-zsh/zsh-syntax-highlighting ]] || \
  cd $HOME/.oh-my-zsh && git clone https://github.com/zsh-users/zsh-syntax-highlighting.git &>/dev/null && cd - >/dev/null
